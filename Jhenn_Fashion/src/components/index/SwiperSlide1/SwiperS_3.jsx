            ...
            >
                <div className="img-wrapper">
                    <CSSTransition
                        ...
                        unmountOnExit
                    >
                        <img src="/src/assets/img/25.png" alt="..." className="img-fade" />
                    </CSSTransition>
                    <CSSTransition
                        in={isHovered}
                        timeout={1000}
                        ...
                        unmountOnExit
                    >
                        <img src="/src/assets/img/12.png" alt="..." className="img-fade" />
                    </CSSTransition>
                    ...
                    <div className={`cont-ver-pro d-none d-lg-flex ${isHovered ? 'show' : ''}`}>
                        <div className="ver-producto" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Vista Previa">
                            <i className="fa-sharp fa-solid fa-eye" data-bs-toggle="modal" data-bs-target='#exampleModal'></i>
                        </div>
                    </div>
